...
then overlays config.yaml (if present) so your personal settings win. New users who
only have the example file still get a fully working configuration. Every key is optional.
"""
import os, json
...
DEFAULTS = {
    ...
    "topics_k": 12,
    "top_chats": 60,
    "include_examples": True,   # embed a sample of real messages in the dashboard explorer
